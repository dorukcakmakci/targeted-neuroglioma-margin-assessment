...
secondary_task_name = "control_tumor"
base = os.path.join('/home/doruk/glioma_quantification/cpmg/quantification/',secondary_task_name)
model_name = f"network_per_metabolite/{task}/seed_{SEED}/"
