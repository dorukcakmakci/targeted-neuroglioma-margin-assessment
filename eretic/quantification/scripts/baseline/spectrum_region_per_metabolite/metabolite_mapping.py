...
metabolite_database_path = (
    "/home/doruk/glioma_quantification/data/metabolite_ppm_database_baseline.xlsx"
)
...
shift_factor = 50
for metabolite, start, end in zip(
    metabolites, metabolite_peak_start, metabolite_peak_end
):
    if math.isnan(start) or math.isnan(end):
        ...
        shift_at_right_end = (
            e_end + shift_factor
            if e_end + shift_factor < spectrum_length
            else spectrum_length - 1
        )
