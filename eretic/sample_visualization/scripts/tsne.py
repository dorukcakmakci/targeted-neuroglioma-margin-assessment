...
plt.figure()
plt.title("Control, Benign and Aggressive Tumor Eretic-CPMG Samples (TSNE on raw spectrum)")
...
# plot tsne (control, benign and aggressive) 
plt.figure()
plt.title("Control, Benign and Aggressive Tumor Samples (TSNE on uncharacterised region)")
plt.scatter(transformed_spectra[control_idx][:,0], transformed_spectra[control_idx][:,1], c="r", label="Control")
plt.scatter(transformed_spectra[benign_idx][:,0], transformed_spectra[benign_idx][:,1], c="y", label="Benign")
plt.scatter(transformed_spectra[aggressive_idx][:,0], transformed_spectra[aggressive_idx][:,1], c="g", label="Aggressive")
plt.xlabel("Component 1")
...
# plot tsne (control, benign and aggressive) 
plt.figure()
plt.title("Control, Benign and Aggressive Tumor Samples (TSNE on ground truth metabolites)")
plt.scatter(transformed_spectra[control_idx][:,0], transformed_spectra[control_idx][:,1], c="r", label="Control")
plt.scatter(transformed_spectra[benign_idx][:,0], transformed_spectra[benign_idx][:,1], c="y", label="Benign")
plt.scatter(transformed_spectra[aggressive_idx][:,0], transformed_spectra[aggressive_idx][:,1], c="g", label="Aggressive")
plt.xlabel("Component 1")
...
# plot tsne (control, benign and aggressive) 
plt.figure()
plt.title("Control, Benign and Aggressive Tumor Samples (TSNE on predicted metabolites)")
plt.scatter(transformed_spectra[control_idx][:,0], transformed_spectra[control_idx][:,1], c="r", label="Control")
plt.scatter(transformed_spectra[benign_idx][:,0], transformed_spectra[benign_idx][:,1], c="y", label="Benign")
plt.scatter(transformed_spectra[aggressive_idx][:,0], transformed_spectra[aggressive_idx][:,1], c="g", label="Aggressive")
plt.xlabel("Component 1")
