...
dataset_excel_path = os.path.join(
    project_base_path, "data/all_eretic_hrmas_dataset.xlsx"
)
dataset_spectra_path = os.path.join(project_base_path, "data/eretic_dataset/")
raw_data_path = os.path.join(project_base_path, "data/eretic/raw/")
