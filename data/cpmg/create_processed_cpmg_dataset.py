...
eretic_idx = statistics_df.index[statistics_df['Spectrum Type'] == "Eretic-CPMG"].tolist()
eretic_statistics = statistics_df[statistics_df.index.isin(eretic_idx)].reset_index(drop=True)
